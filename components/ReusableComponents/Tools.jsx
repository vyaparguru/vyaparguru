    ...
    <section className="py-4 md:py-10 px-6 md:px-40">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-20">
          {tools.map((tool, index) => (
            <div key={tool.slug || index} className='flex flex-col md:gap-2'>
              <div className="relative h-40 md:h-52 bg-gray-300 bg-cover bg-center rounded-lg flex items-end p-6" style={{ backgroundImage: `url(${tool.src})` }}/>
