  ...
  return (
    <section className=" py-16 md:py-40 px-6 md:px-20 lg:px-40 flex flex-col md:flex-row items-center gap-10 md:gap-14">
      ...
      <div className="md:w-1/2">
        ...
        <Link href="/services/digital-marketing" className="inline-block px-6 py-3 text-blue-500 font-medium border-2 border-blue-500 rounded-md hover:bg-blue-500 hover:text-white transition">
            Explore More →
        </Link>
      </div>
    </section>
